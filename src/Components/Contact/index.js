...
function ContactForm() {
  ...
  return (
    <section>
      <h1 className='text-center m-2' data-testid="h1tag">Contact me</h1>
      <form  className='m-auto p-2 d-flex flex-column w-50' id="contact-form" onSubmit={handleSubmit}>
        <div>
        ...
        <div>
          <label className='p-1' htmlFor="email">Email address:</label>
        ...
        <button className='m-2 btn btn-secondary' data-testid="button" type="submit">Submit</button>
      </form>
    </section>
  );
}
